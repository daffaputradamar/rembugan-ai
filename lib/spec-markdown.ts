...
export function analysisDesignToMarkdown(ad: ANDData): string {
  ...
  if (ad.useCaseDiagram) {
    lines.push("## 4. Use Case Diagram", "", "```", ad.useCaseDiagram, "```", "")
  }

  if (ad.erdDiagram) {
    lines.push("## 5. Entity Relationship Diagram (ERD)", "", "```", ad.erdDiagram, "```", "")
  }

  if (ad.systemArchitecture) {
    lines.push("## 6. System Architecture (C4 – Level 1)", "", "```", ad.systemArchitecture, "```", "")
  }

  if (ad.containerDiagram) {
    lines.push("## 7. High-Level Design (C4 – Level 2)", "", "```", ad.containerDiagram, "```", "")
  }
  ...
  if (ad.sequenceDiagram) {
    lines.push("## 9. Sequence Diagram", "", "```", ad.sequenceDiagram, "```", "")
  }
  ...
  if (ad.deploymentArchitecture) {
    lines.push("## 12. Deployment Architecture", "", "```", ad.deploymentArchitecture, "```", "")
  }
...
export function testScenarioToMarkdown(ts: TestScenarioData): string {
  ...
  if (ts.referenceDocuments.length) {
    ...
    ts.referenceDocuments.forEach((doc, idx) => {
      lines.push(`${idx + 1}. **${doc.name}** (Version ${doc.version}, ${doc.date})`)
    })
    lines.push("")
  }
...
export function specToMarkdown(spec: SpecData, summary?: string): string {
  ...
  if (spec.urd.acceptanceCriteria) {
    lines.push("## 9. Acceptance Criteria", "", spec.urd.acceptanceCriteria, "")
  }
  ...
  if (spec.analysisDesign.asIsProcess) {
    lines.push("## 2. Business Process Flow (AS-IS)", "", spec.analysisDesign.asIsProcess, "")
  }

  if (spec.analysisDesign.toBeProcess) {
    lines.push("## 3. Business Process Flow (TO-BE)", "", spec.analysisDesign.toBeProcess, "")
  }

  if (spec.analysisDesign.useCaseDiagram) {
    lines.push("## 4. Use Case Diagram", "", "```", spec.analysisDesign.useCaseDiagram, "```", "")
  }

  if (spec.analysisDesign.erdDiagram) {
    lines.push("## 5. Entity Relationship Diagram (ERD)", "", "```", spec.analysisDesign.erdDiagram, "```", "")
  }

  if (spec.analysisDesign.systemArchitecture) {
    lines.push("## 6. System Architecture (C4 – Level 1)", "", "```", spec.analysisDesign.systemArchitecture, "```", "")
  }

  if (spec.analysisDesign.containerDiagram) {
    lines.push("## 7. High-Level Design (C4 – Level 2)", "", "```", spec.analysisDesign.containerDiagram, "```", "")
  }
  ...
  if (spec.analysisDesign.sequenceDiagram) {
    lines.push("## 9. Sequence Diagram", "", "```", spec.analysisDesign.sequenceDiagram, "```", "")
  }
  ...
  if (spec.analysisDesign.deploymentArchitecture) {
    lines.push("## 12. Deployment Architecture", "", "```", spec.analysisDesign.deploymentArchitecture, "```", "")
  }
  ...
  if (spec.testScenario.acceptanceCriteria) {
    lines.push("## 7. Acceptance Criteria", "", spec.testScenario.acceptanceCriteria, "")
  }
